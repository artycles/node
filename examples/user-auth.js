...
app.get('/', function(req, res){
	if( req.user ){
		...
		//var auth =
		res.send('<html><body><a href="/auth/artycles">Login</a></body></html>');
	}
	res.end();
});


app.get('/auth/artycles', artycles.auth());

app.get('/auth/artycles/callback', artycles.auth({ successRedirect: '/', failureRedirect: '/'}) );
