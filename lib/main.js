var _ = require("underscore"),
	...
	Strategy = require("passport-artycles").Strategy;
...
var API = function( options ){
	...
	passport.use(new Strategy({
		...
		callbackURL: "/auth/artycles/callback", // option?
...
API.prototype = {
	...
	auth: function(){
		if( arguments[1] ) {
			return passport.authenticate('artycles', arguments[0], arguments[1]);
		} else {
			return passport.authenticate('artycles', arguments[0]);
		}
	},
	...
	// DEPRECATE: alias for login
	password: function( creds, callback ){
		return this.login( creds, callback );
	}
